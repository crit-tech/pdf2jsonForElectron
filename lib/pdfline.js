...
export default class PDFLine {
  ...
  processLine(targetData) {
    ...
    if (yDelta < this.lineWidth && xDelta > minDelta) {
      ...
      if (this.x1 > this.x2) this.#setStartPoint(oneLine, this.x2, this.y2);
      else this.#setStartPoint(oneLine, this.x1, this.y1);
      ...
      if (this.y1 > this.y2) this.#setStartPoint(oneLine, this.x2, this.y2);
      else this.#setStartPoint(oneLine, this.x1, this.y1);
