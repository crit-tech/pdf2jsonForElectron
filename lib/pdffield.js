...
export default class PDFField {
  ...
  static isWidgetSupported(field) {
    ...
    switch (field.fieldType) {
      ...
      case "Sig":
        ...
        break; //signature
      default:
        console.warn("Unsupported: field.fieldType of " + field.fieldType);
        break;
    }
  ...
  static isFormElement(field) {
    ...
    switch (field.subtype) {
      case "Widget":
        ...
        break;
      default:
        console.warn("Unsupported: field.type of " + field.subtype);
        break;
    }
    return retVal;
  }
  ...
  #addRadioButton(box) {
    ...
    const rdGroup = this.Boxsets.filter(
      (boxset) =>
        "id" in boxset && "Id" in boxset.id && boxset.id.Id === box.fullName
    )[0];
  ...
  processField() {
    ...
    switch (this.field.fieldType) {
      case "Tx":
        this.#addAlpha(this.field);
        break;
      case "Cb":
        this.#addCheckBox(this.field);
        break;
      case "Rd":
        this.#addRadioButton(this.field);
        break;
      case "Btn":
        this.#addLinkButton(this.field);
        break;
      case "Ch":
        this.#addSelect(this.field);
        break;
      case "Sig":
        this.#addSignature(this.field);
        break;
    }
